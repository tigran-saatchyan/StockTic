...
def check_ticker_prices():
    ...
    for notification in notifications:
        ...
        if (
                notification.notification_criteria == 'more_than' and current_price > notification.notification_value) or \
                (
                        notification.notification_criteria == 'less_than' and current_price < notification.notification_value):
